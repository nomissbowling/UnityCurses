...
namespace Assets.Scripts.Engine.Utility
{
    ...
    public enum DeveloperEntitlements
    {
        ...
        /// </summary>
        [Description("Subject: Vladimir Gagarin - Age: 27")] PlayerName,

        /// <summary>
        ///     Explains to the player that Vlad is indeed Russian if they could not get that from his name.
        /// </summary>
        [Description("Nationality: Russian")] PlayerNationality,

        /// <summary>
        ///     Title of the game and also the occupation of the player character.
        /// </summary>
        [Description("Occupation: Space Trucker")] PlayerJob,

        /// <summary>
        ///     Arf!
        /// </summary>
        [Description("Lead Programming: Ron \"Maxwolf\" McDowell")] Maxwolf,

        /// <summary>
        ///     Yip!
        /// </summary>
        [Description("Additional Programming: Kyle \"Fox\" Polulak")] Fox,

        /// <summary>
        ///     Rufus!
        /// </summary>
        [Description("Models and Artwork: Sam \"Prowler\" Coleman")] Prowler,

        /// <summary>
        ///     Helped us get greenlit, thank you!
        /// </summary>
        [Description("Publishing Assistance: WE LOVE WOLVES")] LittleWolfe
    }
}