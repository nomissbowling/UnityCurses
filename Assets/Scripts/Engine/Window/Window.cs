...
using Assets.Scripts.Engine.Window.Menu;

namespace Assets.Scripts.Engine.Window
{
    /// <summary>
        ...
        where TData : WindowData, new()
    {
        ...
        {
            // Setup default prompt text for asking for input from user.
            ...
            _userData = FactoryExtensions.New<TData>.Instance();
        ...
        public string OnRenderWindow()
        {
            ...
            else
            {
                ...
                var prependMessage = string.Empty;

                if (Form != null)
                    prependMessage = Form.OnRenderForm();
