...
namespace Assets.OregonTrail.Window.Travel.Hunt.Help
{
    ...
    public sealed class HuntingPrompt : InputForm<TravelInfo>
    {
        ...
        protected override string OnDialogPrompt()
        {
            ...
            // Init the prompt for explaining how hunting works.
            huntHelp.AppendLine(string.Format("{0}Hunting Instructions{1}", Environment.NewLine, Environment.NewLine));
            ...
            huntHelp.AppendLine(huntTextTop.WordWrap(32));
            huntHelp.AppendLine(huntTextBottom.WordWrap(32));
