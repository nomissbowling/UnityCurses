    ...
    public sealed class DeathPlayer : EventProduct
    {
        ...
        public override void Execute(RandomEventInfo eventExecutor)
        {
            ...
            if (sourcePerson == null)
                throw new ArgumentNullException("eventExecutor", "Could not cast source entity as player.");
            ...
            _leaderDeath.AppendLine(string.Format("{0} has died.", sourcePerson.Name));
        }
