...
namespace Assets.OregonTrail.Module.Tombstone
{
    /// <summary>
    ...
    ///     trail.
    /// </summary>
    public sealed class TombstoneModule : Engine.Module.Module
    {
        private readonly Dictionary<int, Tombstone> _tombstones;
        ...
        {
            _tombstones = new Dictionary<int, Tombstone>();
        ...
        /// </summary>
        private Dictionary<int, Tombstone> Tombstones
        {
