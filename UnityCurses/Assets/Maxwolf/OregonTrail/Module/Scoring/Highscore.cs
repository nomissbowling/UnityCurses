...
namespace Assets.Maxwolf.OregonTrail.Module.Scoring
{
    /// <summary>
    ...
    public sealed class Highscore
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Assets.Maxwolf.OregonTrail.Module.Scoring.Highscore" /> class.</summary>
