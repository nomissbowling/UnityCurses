...
namespace Assets.Maxwolf.OregonTrail.Window.Travel.RiverCrossing.Indian
{
    /// <summary>
    ...
    public sealed class IndianGuidePrompt : InputForm<TravelInfo>
    {
        ...
        private bool HasEnoughClothingToTrade
        {
            get
            {
                return OregonTrailApp.Instance.Vehicle.Inventory[Entities.Clothes].Quantity >=
        ...
        protected override string OnDialogPrompt()
        {
            ...
            _prompt.AppendLine(string.Format("{0}A Shoshoni guide says that he", Environment.NewLine));
            _prompt.AppendLine("will take your wagon across");
            _prompt.AppendLine(string.Format("the river in exchange for {0:N0}", UserData.River.IndianCost));
            _prompt.AppendLine(string.Format("sets of clothing.{0}", Environment.NewLine));
            ...
            else
            {
                ...
                _prompt.AppendLine(string.Format("You don't have {0} sets of", UserData.River.IndianCost));
                _prompt.AppendLine(string.Format("clothing.{0}", Environment.NewLine));
            }
