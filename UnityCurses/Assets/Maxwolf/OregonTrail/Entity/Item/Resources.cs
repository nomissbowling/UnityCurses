...
namespace Assets.Maxwolf.OregonTrail.Entity.Item
{
    ...
    public static class Resources
    {
        ...
        {
            get { return new SimItem(Entities.Clothes, "Clothing", "sets", "set", 50, 10, 1, 1, 0, 2, 1); }
        }
        ...
        {
            get { return new SimItem(Entities.Vehicle, "Vehicle", "vehicles", "vehicle", 2000, 50, 500, 1, 0, 50, 1); }
        }
        ...
        {
            get { return new SimItem(Entities.Person, "Person", "people", "person", 2000, 0, 1, 1, 0, 800, 1); }
        }
