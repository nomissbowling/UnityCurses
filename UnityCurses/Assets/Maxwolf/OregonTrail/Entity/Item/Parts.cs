...
namespace Assets.Maxwolf.OregonTrail.Entity.Item
{
    ...
    public static class Parts
    {
        ...
        {
            get { return new SimItem(Entities.Animal, "Oxen", "oxen", "ox", 20, 20, 0, 1, 0, 4, 1); }
        }
        ...
        {
            get { return new SimItem(Entities.Axle, "Vehicle Axle", "axles", "axle", 3, 10, 0, 1, 0, 2, 1); }
        }
        ...
        {
            get { return new SimItem(Entities.Tongue, "Vehicle Tongue", "tongues", "tongue", 3, 10, 0, 1, 0, 2, 1); }
        }
        ...
        {
            get { return new SimItem(Entities.Wheel, "Vehicle Wheel", "wheels", "wheel", 3, 10, 0, 1, 0, 2, 1); }
        }
    }
}