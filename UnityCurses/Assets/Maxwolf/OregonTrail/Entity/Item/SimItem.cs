...
namespace Assets.Maxwolf.OregonTrail.Entity.Item
{
    /// <summary>
    ...
    {
        private readonly Entities _category;
        private readonly float _cost;
        private readonly string _delineatingUnit;
        ...
        private readonly int _pointsPerAmount;
            ...
            int pointsPerAmount)
        {
            ...
            _delineatingUnit = delineatingUnit;
        ...
        public SimItem(SimItem oldItem, int newQuantity)
        {
            ...
            _minQuantity = oldItem.MinQuantity;
            _maxQuantity = oldItem.MaxQuantity;
            _startingQuantity = oldItem.StartingQuantity;

            // Scoring information for points tabulation if player wins the game.
            _pointsPerAmount = oldItem.PointsPerAmount;
            _pointsAwarded = oldItem.PointsAwarded;
            ...
            _name = oldItem.Name;
            _category = oldItem.Category;
            _cost = oldItem.Cost;
            _delineatingUnit = oldItem.DelineatingUnit;
            _pluralForm = oldItem.PluralForm;
            _weight = oldItem.Weight;
        }
        ...
        ///     'ox'.
        /// </summary>
        public string DelineatingUnit
        {
            get { return _delineatingUnit; }
        }
        ...
        /// </summary>
        public int PointsPerAmount
        {
            get { return _pointsPerAmount; }
        }
        ...
        {
            return !storeMode
                ? string.Format("{0:F2} per {1}", Cost, DelineatingUnit)
