...
{
	class OrderByEnumerable<TElement, TKey> : System.Linq.IOrderedEnumerable<TElement>
	{
		...
		public System.Linq.IOrderedEnumerable<TElement> CreateOrderedEnumerable<TNewKey> (
	    ...
	    public System.Linq.IOrderedEnumerable<TElement> CreateOrderedEnumerable<TKey1>(System.Func<TElement, TKey1> selector, IComparer<TKey1> comparer, bool @descending)
	    {
