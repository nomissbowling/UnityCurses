...
using Assets.Source.OregonTrail.Module.Scoring;
using Assets.Source.OregonTrail.Module.Time;
using Assets.Source.OregonTrail.Module.Tombstone;
using Assets.Source.OregonTrail.Module.Trail;
using Assets.Source.OregonTrail.Window.GameOver;
using Assets.Source.OregonTrail.Window.Graveyard;
using Assets.Source.OregonTrail.Window.MainMenu;
using Assets.Source.OregonTrail.Window.RandomEvent;
using Assets.Source.OregonTrail.Window.Travel;

namespace Assets.Source.OregonTrail
{
    /// <summary>
