...
namespace Assets.Source.OregonTrail.Module.Trail
{
    /// <summary>
    ...
    public sealed class Trail
    {
        ...
        private readonly int _lengthMax;

        private readonly int _lengthMin;
        ...
        public Trail(IEnumerable<Location> locations, int lengthMin, int lengthMax)
        {
            ...
            if (locations == null)
                throw new ArgumentNullException("locations", "List of locations for trail was null!");

            // Init a new empty trail dictionary.
        ...
        private int GenerateDistances()
        {
            ...
            GenerateDistancesRecursive(_locations, 0);
        ...
        ///     locations.
        /// </param>
        private void GenerateDistancesRecursive(IEnumerable<Location> locations, int locationDepth)
        {
