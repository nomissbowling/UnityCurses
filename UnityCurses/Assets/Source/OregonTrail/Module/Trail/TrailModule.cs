...
namespace Assets.Source.OregonTrail.Module.Trail
{
    ...
    /// </summary>
    public sealed class TrailModule : Engine.Module.Module
    {
        /// <summary>
        ...
        public override void OnTick(bool systemTick, bool skipDay)
        {
            ...
            var vehicle = OregonTrailApp.Instance.Vehicle;
            ...
            if (CurrentLocation != null)
            {
                ...
                if (CurrentLocation != null && CurrentLocation.Status == LocationStatus.Arrived &&
                    DistanceToNextLocation <= 0)
                    return;
            }
        ...
        public void ArriveAtNextLocation()
        {
            ...
            if (OregonTrailApp.Instance.TotalTurns > 0)
                LocationIndex++;
