...
namespace Assets.Source.OregonTrail.Module.Director
{
    ...
    /// </summary>
    public sealed class EventDirectorModule : Engine.Module.Module
    {
        /// <summary>
        ...
        public void TriggerEventByType(IEntity sourceEntity, EventCategory eventCategory)
        {
            ...
            // Init a random event by type enumeration, event factory will randomly pick one for us based on the enum value.
