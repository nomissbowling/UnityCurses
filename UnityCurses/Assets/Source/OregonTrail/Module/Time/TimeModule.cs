...
namespace Assets.Source.OregonTrail.Module.Time
{
    /// <summary>
    ...
    /// </summary>
    public sealed class TimeModule : Engine.Module.Module
    {
        /// <summary>
        ...
        public TimeModule()
        {
            // Init a new time object for our simulation.
            CurrentYear = 1848;
        ...
        private void OnTickDay(bool skipDay)
        {
            ...
            OregonTrailApp.Instance.Trail.OnTick(false, skipDay);
        }
