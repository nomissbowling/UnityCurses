...
using Assets.Source.OregonTrail.Window.Travel.Hunt.Help;
...
using Assets.Source.OregonTrail.Window.Travel.Trade;

namespace Assets.Source.OregonTrail.Window.Travel
{
    /// <summary>
    ...
    public sealed class Travel : Window<TravelCommands, TravelInfo>
    {
        ...
        internal void ContinueOnTrail()
        {
            ...
            if (OregonTrailApp.Instance.Trail.CurrentLocation.Status == LocationStatus.Departed)
            {
            ...
            if (OregonTrailApp.Instance.Trail.CurrentLocation is Landmark ||
                ...
                OregonTrailApp.Instance.Trail.CurrentLocation is TollRoad)
        ...
        private void HuntForFood()
        {
            ...
            SetForm(OregonTrailApp.Instance.Vehicle.Inventory[Entities.Ammo].Quantity > 0
        ...
        private void UpdateLocation()
        {
            ...
            var location = OregonTrailApp.Instance.Trail.CurrentLocation;
