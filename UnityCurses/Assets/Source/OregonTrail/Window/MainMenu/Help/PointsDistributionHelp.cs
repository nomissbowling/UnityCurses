...
namespace Assets.Source.OregonTrail.Window.MainMenu.Help
{
    ...
    public sealed class PointsDistributionHelp : InputForm<NewGameInfo>
    {
        ...
        protected override string OnDialogPrompt()
        {
            ...
            _pointsHealth.AppendLine(string.Format("{0}On Arriving in Oregon{1}", Environment.NewLine,
                Environment.NewLine));
            ...
            _pointsHealth.AppendLine(string.Format("in good health!{0}", Environment.NewLine));
