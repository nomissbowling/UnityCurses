...
namespace Assets.Source.OregonTrail.Window.MainMenu.Help
{
    /// <summary>
    ...
    public sealed class StoreHelp : InputForm<NewGameInfo>
    {
        ...
        protected override string OnDialogPrompt()
        {
            ...
            _storeHelp.Append(string.Format("{0}You can buy whatever you need at{1}", Environment.NewLine,
                Environment.NewLine));
            _storeHelp.Append(string.Format("Matt's General Store.{0}{1}", Environment.NewLine, Environment.NewLine));
