...
namespace Assets.Source.OregonTrail.Window.GameOver
{
    /// <summary>
    ...
    public sealed class GameWin : InputForm<GameOverInfo>
    {
        ...
        {
            _gameOver.AppendLine(string.Format("{0}Congratulations! You have ", Environment.NewLine));
            _gameOver.AppendLine("made it to Oregon! Let's see ");
            _gameOver.AppendLine("how many points you have ");
            _gameOver.AppendLine(string.Format("received.{0}", Environment.NewLine));
