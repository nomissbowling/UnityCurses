...
namespace Assets.Source.OregonTrail.Entity.Location
{
    /// <summary>
    ...
    public abstract class Location : ILocation
    {
        ...
        private readonly LocationWarning _warning;
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Assets.Source.OregonTrail.Entity.Location.Location" /> class.</summary>
        ...
        /// </summary>
        public LocationWarning Warning
        {
            get { return _warning; }
        }
