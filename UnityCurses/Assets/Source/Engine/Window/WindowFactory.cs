...
namespace Assets.Source.Engine.Window
{
    /// <summary>
    ...
    public sealed class WindowFactory
    {
        ...
        public WindowFactory(EngineApp simUnit)
        {
            // Copy over reference for simulation core.
            _simUnit = simUnit;

            // Init dictionaries for holding statistics about times run and for reference loading.
            _windows = new Dictionary<string, Type>();
        ...
        /// </summary>
        private Dictionary<string, Type> Windows
        {
            get { return _windows; }
        }
