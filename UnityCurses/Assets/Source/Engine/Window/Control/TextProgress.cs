...
namespace Assets.Source.Engine.Window.Control
{
    /// <summary>
    ...
    public static class TextProgress
    {
        ...
        public static string DrawProgressBar(int value, int maxValue, int barSize)
        {
            ...
            char progressCharacter = Convert.ToChar(9608);
            char barCharacter = Convert.ToChar(9618);

            // Build visual progress representation.
            StringBuilder output = new StringBuilder();
            decimal perc = value / (decimal) maxValue;
            ...
            output.AppendFormat(" {0:N2}%", (perc * 100));
