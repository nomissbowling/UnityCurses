...
namespace Assets.Source.Engine.Window.Form
{
    /// <summary>
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="T:Assets.Source.Engine.Window.Form.ParentWindowAttribute" /> class.</summary>
